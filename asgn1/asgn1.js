...
function addActionsForHtmlUI(){
  ...
  //Background Color
  document.getElementById('setBGColor').onclick = function() {gl.clearColor(g_selectedColor[0],g_selectedColor[1],g_selectedColor[2],g_selectedColor[3]); gl.clear(gl.COLOR_BUFFER_BIT); g_shapesList = []; renderAllShapes();};

  //Drawing
  document.getElementById('Drawing').onclick =  function() {painting();};
